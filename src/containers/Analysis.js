                                ...
                                <div className="h-full flex flex-col py-6 bg-white shadow-xl overflow-y-scroll">
                                    ...
                                    <div className="mt-6 relative flex-1 px-4 sm:px-6">
                                        <div className="prose">
                                            ...
                                            <p>
                                                This website shows what the Party and Big Brother could look like today as a modern-day tech company, pitching its dystopian offerings as upsides for consumers. It aims to prod the viewer to think about the things around us that we take for granted, and how they’re related to <em>1984</em>.
                                            </p>
                                            <p>
